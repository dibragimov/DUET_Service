...
namespace DUETCPMConsole
{
    public class HashUtility
    {
        ...
        public static string CalculateMD5(string sessionId, int clientAccountId, int ctrgAccountId, int ctrgClientAccountId, int contractBindId, string externalDocDate, string externalDocNumber, decimal feeAmount, int functionType, string paymentDetails, decimal transactAmount, string curDate)
        {
